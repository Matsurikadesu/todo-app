...
const InputListItemEditable = ({element, index, handleInputDelete, isColumn = false}) => {
    ...
    return(
        <div className='card__subtask-input'>
            <input className='popup__input-field' data-testid='elementinput' maxLength={100} type="text" {...register(`elements.${index}.name`)} placeholder={isColumn ? 'column name' : element.placeholder} defaultValue={isColumn ? element.name : ''}/>
